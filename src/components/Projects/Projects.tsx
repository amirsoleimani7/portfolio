            ...
            <div className="flex flex-col p-5 
             border border-gray-800 *:select-none group cursor-pointer duration-200 ease-in-out transition-all hover:border-gray-600">
              <div className="overflow-hidden relative ">
                ...
                <div className="flex gap-2 p-2 justify-end w-full h-15 z-10 duration-200 ease-linear opacity-0 group-hover:opacity-100 transition-all translate-y-full group-hover:-translate-y-full backdrop-blur-xl bg-black/5">
